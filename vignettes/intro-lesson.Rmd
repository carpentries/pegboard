...
```{r intro-read-noshow-children, echo = FALSE}
...
determine its parent and its final ancestor. 

```{r show-parent}
# cat.Rmd's parent is intro.Rmd
wb_lesson_child$children[[1]]$name
wb_lesson_child$children[[1]]$parents
wb_lesson_child$children[[1]]$build_parents

# session.Rmd's parent is cat.Rmd
wb_lesson_child$children[[2]]$name
wb_lesson_child$children[[2]]$parents
wb_lesson_child$children[[2]]$build_parents
```
...
print(parent)
wb_lesson_child$trace_lineage(parent)
```
